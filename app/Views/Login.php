...
<body>
    ...
    <div align="center">
        <form action="<?= base_url('login/authenticate') ?>" method="POST">
            ...
            <input type="text" name="email" class="champ" size="25" required placeholder="Username">
            ...
            <p>Vous n'avez pas encore de compte? <a href="<?= base_url('register') ?>">S'inscrire</a></p>
        </form>
